...
def label_mapto_capture24(Y, FILTERED_LABEL, walmsley2020=False, willetts2018=False):
    ...
    mapping =   {
                'syncJumping': "unknown" #change
                , 'standing': "standing"
                , 'step': "walking"
                , 'lyingDownLeft': "sleep"
                , 'lyingDownRight': "sleep"
                , 'sittingSofa': "sitting"
                , 'sittingCouch': "sitting"
                , 'sittingChair': "sitting"
                , 'walkingStairsUp': "walking"
                , 'dishwashing': "household-chores"
                , 'stakingShelves': "unknown" #change
                , 'vacuumCleaning': "unknown" #change
                , 'walkingSlow': "walking"
