...
script="$ABSOLUTE_PATH/2-Dataset/preprocessing/newcastle/mtssl_finetune_newcastle.py"

case $choice in 
    [yY] )
        job_name="ftdat-newcastle-relabel"
        relabel="--relabel"
        ;;
    [nN] )
        job_name="ftdat-newcastle-adl"
        relabel=""
        ;;
esac
