...
def label_mapto_capture24(Y, FILTERED_LABEL, walmsley2020=False, willetts2018=False):
    ...
    mapping = {
                "Keyboard typing": "sitting", 
                "Using mouse": "unknown", # changed
                "Handwriting": "sitting",
                "Cutting vegetables": "unknown", # changed
                "Stir-frying vegetables": "unknown", # changed
                "Wiping the table": "household-chores",
                "Sweeping floor": "household-chores",
                "Using vacuum to vacuum": "unknown", # changed
                "Open and close drawer": "unknown", # changed
              }
