...
echo "climbingdown, climbingup, jumping, lying, running, sitting, standing, walking"
echo "--------------------"
...
script="$ABSOLUTE_PATH/2-Dataset/preprocessing/realworld/mtssl_finetune_realworld.py"

case $choice in 
    [yY] )
        job_name="ftdat-realworld-relabel"
        relabel="--relabel"
        ;;
    [nN] )
        job_name="ftdat-realworld"
        relabel=""
        ;;
esac
