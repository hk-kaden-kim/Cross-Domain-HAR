...
echo "'RELAX'","'KEYBOARD_WRITING'","'LAPTOP","'HANDWRITING'","'HANDWASHING'",
echo "'FACEWASHING'","'TEETHBRUSH'","'SWEEPING'","'VACUUMING'","'EATING'",
echo "'DUSTING'","'RUBBING'","'DOWNSTAIRS'","'WALKING'","'WALKING_FAST'",
echo "'UPSTAIRS_FAST'","'UPSTAIRS'",
echo "--------------------"
...
script="$ABSOLUTE_PATH/2-Dataset/preprocessing/harvardleo/mtssl_finetune_harvardleo.py"

case $choice in 
    [yY] )
        job_name="ftdat-harvardleo-relabel"
        relabel="--relabel"
        ;;
    [nN] )
        job_name="ftdat-harvardleo-adl"
        relabel=""
        ;;
esac
