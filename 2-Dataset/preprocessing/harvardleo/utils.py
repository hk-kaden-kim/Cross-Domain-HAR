...
def label_mapto_capture24(Y, FILTERED_LABEL, walmsley2020=False, willetts2018=False):
    ...
    mapping =   {
        'RELAX':"unknown", #change 
        'KEYBOARD_WRITING':"sitting",
        'LAPTOP':"sitting",
        'HANDWRITING':"sitting",
        'HANDWASHING':"household-chores",
        'FACEWASHING':"household-chores",
        'TEETHBRUSH':"household-chores",
        'SWEEPING':"household-chores",
        'VACUUMING':"unknown", #change 
        'EATING':"sitting", #change 
        'DUSTING':"household-chores",
        'RUBBING':"household-chores", #change 
        'DOWNSTAIRS':"walking",
        'WALKING':"walking",
        'WALKING_FAST':"walking",
        'UPSTAIRS_FAST':"walking",
        'UPSTAIRS':"walking",
                }
