...
echo "NoREM,awake,movements (all of them classified as sleep)"
echo "--------------------"
...
script="$ABSOLUTE_PATH/2-Dataset/preprocessing/ichi14/mtssl_finetune_ichi14.py"

case $choice in 
    [yY] )
        job_name="ftdat-ichi14-relabel"
        relabel="--relabel"
        ;;
    [nN] )
        job_name="ftdat-ichi14-adl"
        relabel=""
        ;;
esac
