...
export FTMODEL="base"
export PATH2FT_WEIGHT="$HOME/mp_project/t-st-2023-OneShot-HAR-Hyeongkyun-Orestis/3-Model/_finetuning/_baseline/_model/$FTMODEL"
# =============================================

# =============================================
# SETTING 2
export OUTPUTPREFIX="base_base_unkn"
