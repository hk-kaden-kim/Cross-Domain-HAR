...
export UNKNOWN_UNKNOWN_PATH="$SCRATCH"/mp-dataset/__Important__/test_unknown_all_30hz_w10/relabel/Willetts2018/
export USE_UNKNOWN="True"

# =============================================
# SETTING 1
# Choose finetuned model's weight used for inference.
export FTMODEL="4_scl"         # 4_axsw        4_axr           4_scl
export PATH2FT_WEIGHT="$HOME/mp_project/t-st-2023-OneShot-HAR-Hyeongkyun-Orestis/3-Model/_finetuning/_4-augtech/_model/$FTMODEL"
# =============================================

# =============================================
# SETTING 2
export OUTPUTPREFIX="CUAa_base_unkn"
...
python "${PATH2SOURCEROOT}/_inference.py" \
        ...
        data.unknown_unknown_path=$UNKNOWN_UNKNOWN_PATH \
