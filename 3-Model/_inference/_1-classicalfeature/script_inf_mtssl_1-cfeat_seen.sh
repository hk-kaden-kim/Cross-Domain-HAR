...
export FTMODEL="1_c_feat"
export PATH2FT_WEIGHT="$HOME/mp_project/t-st-2023-OneShot-HAR-Hyeongkyun-Orestis/3-Model/_finetuning/_1-classicalfeature/_model/$FTMODEL"
# =============================================

# =============================================
# SETTING 2
export OUTPUTPREFIX="C_base_unkn"
